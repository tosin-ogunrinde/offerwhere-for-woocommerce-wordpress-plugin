                    ...
                    <div class="offerwhere-card">
                        <div class="offerwhere-d-flex offerwhere-text-white">
                            ...
                            <div class="offerwhere-border-left offerwhere-pl-3">
                                <a href="https://www.offerwhere.com" target="_blank">
                                    <img class="offerwhere-logo" alt="Offerwhere logo"
...
Your PIN <span class="offerwhere-text-uppercase">%s</span> has been applied.</div>',
                ...
                <div class="offerwhere-alert offerwhere-alert-danger">Your PIN cannot be found. <a
                            class="offerwhere-alert-link" href="https://www.offerwhere.com/sign-up" target="_blank">
                        Sign up</a> to get your PIN.
                </div>
                <?php
        ...
        <div class="offerwhere-form offerwhere-mt-3" id="offerwhere-form-ask-user-for-number" style="display: none">
            ...
            <form method="post">
                <div class="offerwhere-pb-4">
                    Enter your <a href="https://www.offerwhere.com" target="_blank">Offerwhere</a> PIN below.
                    If you don't have one, <a href="https://www.offerwhere.com/sign-up"
                                              target="_blank">sign up</a> to get your PIN.
                </div>
                <?php
